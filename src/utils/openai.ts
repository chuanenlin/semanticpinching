...
const PROMPTS = {
  ...
  toSentence: "Convert this text into a short sentence but longer than a word. Return ONLY the sentence, no markdown or special characters:",
  toParagraph: "Convert this text into a short paragraph with 3 sentences. Return ONLY the paragraph text, no markdown or special characters:",
